...
static char crw30[]= {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x19,0xE8,0xF5,0x24,0xC6,0xC0,0x53,0xE4};
static char crw50[]= {0xA9,0xD7,0x32,0xF5,0xE7,0x38,0xE4,0x8A,0x91,0xC8,0x63,0x8B,0x12,0x74,0x66,0x61};
static char crw510[]={0x00,0x00,0x6A,0xB3,0x25,0xE6,0xAB,0xF4,0xDA,0x47,0x28,0x0F,0x35,0x29,0x4B,0x5C};
static char crw20[]= {0x30,0x72,0x49,0xC2,0xE6,0xCA,0x1B,0xFC,0x69,0x8C,0x79,0xB4,0xC6,0x4E,0x81,0x0C};
static char crw00[]= {0x22,0xEC,0xB8,0xB2,0x43,0x85,0xC3,0xB2,0x94,0x1E,0xF7,0xEC,0xC2,0xB5,0x4A,0x09};
static char crw01[]= {0xC0,0xC6,0x86,0x55,0xB6,0x33,0x04,0x08,0x5B,0x5F,0x72,0x2D,0xD4,0x71,0xFE,0x27};
static char crw36[]= {0x27,0xB4,0x88,0x34,0x8D,0x54};
static char crw56[]= {0x09,0x87,0xCF,0x2A,0x61,0x1D};
static char crw26[]= {0xC4,0xFF,0xB3,0x30,0x79,0x5B};
static char crw06[]= {0x01,0x56,0x12,0xE8,0xEE,0x33};
...
char GetKey(unsigned char *buf, uint32_t CAID, unsigned char ident) {
	...
	switch ((CAID << 8) + ident) {
		case 0x0D030400 : memcpy(buf,crw30,16);	return 1;
		case 0x0D030406 : memcpy(buf,crw36,6);	return 1;
		case 0x0D050400 : memcpy(buf,crw50,16);	return 1;
		case 0x0D050406 : memcpy(buf,crw56,6);	return 1;
		case 0x0D051000 : memcpy(buf,crw510,16);return 1;
		case 0x0D02A000 : memcpy(buf,crw20,16);	return 1;
		case 0x0D02A006 : memcpy(buf,crw26,6);	return 1;
		case 0x0D00C000 : memcpy(buf,crw00,16);	return 1;
		case 0x0D00C001 : memcpy(buf,crw01,16);	return 1;
		case 0x0D00C006 : memcpy(buf,crw06,6);	return 1;
	}
	return 0;
}
