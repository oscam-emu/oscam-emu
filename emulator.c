...
// Cryptoworks EMU
static char crw304[]={0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x19,0xE8,0xF5,0x24,0xC6,0xC0,0x53,0xE4}; // Sky Link 23.5E
static char crw308[]={0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x42,0xF0,0x7B,0xE9,0x20,0xC7,0xE0,0xF3}; // Sky Link 23.5E
static char crw50[]= {0xA9,0xD7,0x32,0xF5,0xE7,0x38,0xE4,0x8A,0x91,0xC8,0x63,0x8B,0x12,0x74,0x66,0x61}; // ORF
static char crw510[]={0x00,0x00,0x6A,0xB3,0x25,0xE6,0xAB,0xF4,0xDA,0x47,0x28,0x0F,0x35,0x29,0x4B,0x5C}; // Austriasat
static char crw2a0[]= {0x30,0x72,0x49,0xC2,0xE6,0xCA,0x1B,0xFC,0x69,0x8C,0x79,0xB4,0xC6,0x4E,0x81,0x0C}; // UPC 0.8°W
static char crw28c0[]= {0x6E,0x75,0x6E,0x64,0x85,0x88,0x6E,0x9B,0x08,0x59,0xC4,0x03,0xEA,0xFB,0xD1,0x8A}; // UPC 0.8°W
static char crw28c1[]= {0xA9,0xE9,0x97,0x70,0xCC,0x04,0x50,0x48,0x05,0xA5,0x1F,0xEC,0x67,0x9D,0x03,0x28}; // UPC 0.8°W
static char crw2a80[]= {0xC2,0x29,0xA4,0x03,0x61,0x00,0xE8,0x1A,0x42,0xBA,0xC3,0xC7,0x0E,0xBB,0xC8,0x52}; // UPC 0.8°W
static char crw2a81[]= {0xC2,0x29,0xA4,0x03,0x61,0x00,0xE8,0x1A,0x42,0xBA,0xC3,0xC7,0x0E,0xBB,0xC8,0x52}; // UPC 0.8°
static char crw2a40[]= {0x6B,0x9C,0x61,0xF2,0xAD,0xF7,0x6C,0x7F,0x23,0xCF,0x10,0xE2,0xE4,0xD5,0xF5,0xE2}; // UPC 0.8°W
static char crw2a41[]= {0x3E,0x55,0x24,0xFC,0x02,0x23,0x8F,0x1B,0xE1,0x5B,0x45,0xA9,0x6D,0x52,0xCC,0xF5}; // UPC 0.8°W
static char crw00[]= {0x22,0xEC,0xB8,0xB2,0x43,0x85,0xC3,0xB2,0x94,0x1E,0xF7,0xEC,0xC2,0xB5,0x4A,0x09}; // DigiTurk
static char crw01[]= {0xC0,0xC6,0x86,0x55,0xB6,0x33,0x04,0x08,0x5B,0x5F,0x72,0x2D,0xD4,0x71,0xFE,0x27}; // DigiTurk
static char crw36[]= {0x27,0xB4,0x88,0x34,0x8D,0x54}; // Sky Link 23.5E
static char crw56[]= {0x09,0x87,0xCF,0x2A,0x61,0x1D}; // ORF
static char crw26[]= {0xC4,0xFF,0xB3,0x30,0x79,0x5B}; // UPC 0.8°W
static char crw06[]= {0x01,0x56,0x12,0xE8,0xEE,0x33}; // DigiTurk
...
char GetKey(unsigned char *buf, uint32_t CAID, unsigned char ident) {
	...
	switch ((CAID << 8) + ident) {
		case 0x0D030400 : memcpy(buf,crw304,16);	return 1; // Sky Link 23.5E
		case 0x0D030800 : memcpy(buf,crw308,16);	return 1; // Sky Link 23.5E
		case 0x0D030406 : memcpy(buf,crw36,6);	return 1; // Sky Link 23.5E
		case 0x0D050400 : memcpy(buf,crw50,16);	return 1; // ORF
		case 0x0D050406 : memcpy(buf,crw56,6);	return 1; // ORF
		case 0x0D051000 : memcpy(buf,crw510,16);return 1; // Austriasat
		case 0x0D02A000 : memcpy(buf,crw2a0,16); return 1; // UPC 0.8°W
		case 0x0D028C00 : memcpy(buf,crw28c0,16); return 1; // UPC 0.8°W
		case 0x0D028C01 : memcpy(buf,crw28c1,16); return 1; // UPC 0.8°W
		case 0x0D02A800 : memcpy(buf,crw2a80,16); return 1; // UPC 0.8°W
		case 0x0D02A801 : memcpy(buf,crw2a81,16); return 1; // UPC 0.8°W
		case 0x0D02A400 : memcpy(buf,crw2a40,16); return 1; // UPC 0.8°W
		case 0x0D02A401 : memcpy(buf,crw2a41,16); return 1; // UPC 0.8°W
		case 0x0D02A006 : memcpy(buf,crw26,6);	return 1; // UPC 0.8°W
		case 0x0D00C000 : memcpy(buf,crw00,16);	return 1; // DigiTurk
		case 0x0D00C001 : memcpy(buf,crw01,16);	return 1; // DigiTurk
		case 0x0D00C400 : memcpy(buf,crw00,16);	return 1; // DigiTurk
		case 0x0D00C401 : memcpy(buf,crw01,16);	return 1; // DigiTurk
		case 0x0D00C006 : memcpy(buf,crw06,6);	return 1; // DigiTurk
	}
	return 0;
}
