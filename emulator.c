...
// Cryptoworks EMU
static char crw30[]= {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x19,0xE8,0xF5,0x24,0xC6,0xC0,0x53,0xE4}; // Sky Link 23.5E
...
static char crw20[]= {0x30,0x72,0x49,0xC2,0xE6,0xCA,0x1B,0xFC,0x69,0x8C,0x79,0xB4,0xC6,0x4E,0x81,0x0C}; // UPC 0.8°W
...
char GetKey(unsigned char *buf, uint32_t CAID, unsigned char ident) {
	...
	switch ((CAID << 8) + ident) {
		case 0x0D030400 : memcpy(buf,crw30,16);	return 1; // Sky Link 23.5E
		...
		case 0x0D02A000 : memcpy(buf,crw20,16);	return 1; // UPC 0.8°W
